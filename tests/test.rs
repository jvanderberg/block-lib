...
mod test {
    ...
    use blocks_lib::pieces::Orientation;
    ...
    use blocks_lib::gamestate::GameEvent::*;
    ...
    pub fn drop() {
        ...
        assert!(
            events.contains(&GameEvent::PieceChanged),
    ...
    pub fn test_game_over() {
        ...
        // Drop til you stop
        while gs.drop(blocks_lib::gamestate::DropSpeed::Off) {}
        let events = test_events.events.borrow();
        assert!(
